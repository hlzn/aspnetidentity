...
namespace mvc.Models
{
                                                        ...
                                                        IdentityUserLogin<string>, IdentityUserToken<string>>
    {
        ...
        {
            return obj is CustomIdentityUserStore store &&
                   EqualityComparer<IdentityErrorDescriber>.Default.Equals(ErrorDescriber, store.ErrorDescriber) &&
                   EqualityComparer<IQueryable<IdentityUser>>.Default.Equals(Users, store.Users) &&
                   EqualityComparer<IQueryable<IdentityUser>>.Default.Equals(Users, store.Users);
        }
        ...
        {
            return HashCode.Combine(ErrorDescriber, Users, Users);
        }
